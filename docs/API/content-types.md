...
??? "Property types"
    ...
    | array   | Used for connecting with other Content Types                                                                                                 | items                       | It has to be an object containing `"$ref": "#/components/schemas/DataSource"`, as the items of the array are objects described in DataSource schema |
