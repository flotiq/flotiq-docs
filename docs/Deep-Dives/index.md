...
1. Start with the [Flotiq Starter - Gatsby Blog](https://blog.flotiq.com/flotiq-starter-gatsby-blog) article. You will get a good introduction to the most important parts of the system, yet the tutorial is very simple and you'll quickly end up with a live site, without writing a line of code.
