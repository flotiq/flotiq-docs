...
1. Start with the [Flotiq Starter - NextJS project](/docs/CLI/starting-new-project-nextjs/) article. You will get a good introduction to the most important parts of the system, yet the tutorial is very simple and you'll quickly end up with a live site, without writing a line of code.
